...
const I18N = {
    ...
    translations: {
        fr: {
            ...
            col_monochrome_light: 'Monochromie light (avec fond noir pour JPG)',
            ...
            lic_manage_subscription: 'Gérer ou annuler mon abonnement (portail Lemon Squeezy)',
            ...
            upd_hot_notice: '💡 La mise à jour s\'installe directement dans le plugin. Pensez à relancer Illustrator une fois l\'installation terminée.',
            upd_installer_notice: '📦 Cette version s\'installe avec l\'installeur. Le téléchargement démarre dans votre navigateur : fermez Illustrator, lancez l\'installeur, puis rouvrez Illustrator. Toutes les versions : logotyps.fr/download',
            upd_apply: 'Télécharger et installer',
            upd_installer_download: 'Télécharger l\'installeur',
            upd_close: 'Fermer',
            upd_progress_start: 'Préparation…',
            upd_progress_download: 'Téléchargement',
            upd_progress_install: 'Installation',
            upd_done_title: '✅ Mise à jour installée',
            upd_done_text: 'Fermez puis relancez Illustrator pour utiliser la nouvelle version.',
            upd_error_prefix: 'La mise à jour n\'a pas pu être appliquée : ',
            upd_error_fallback: 'Vous pouvez télécharger l\'installeur à la place.',
            upd_restart_banner: '🔄 Mise à jour installée : relancez Illustrator pour l\'activer.',
            upd_skip: 'Plus tard',
        ...
        en: {
            ...
            col_monochrome_light: 'Light monochrome (with black background for JPG)',
            ...
            lic_manage_subscription: 'Manage or cancel my subscription (Lemon Squeezy portal)',
            lic_licensed: '✓ Licensed',
            lic_license_key_btn: 'License Key',
            ...
            upd_hot_notice: '💡 The update installs directly into the plugin. Remember to relaunch Illustrator once it is done.',
            upd_installer_notice: '📦 This version installs with the installer. The download starts in your browser: quit Illustrator, run the installer, then relaunch Illustrator. All versions: logotyps.fr/download',
            upd_apply: 'Download and install',
            upd_installer_download: 'Download installer',
            upd_close: 'Close',
            upd_progress_start: 'Preparing…',
            upd_progress_download: 'Downloading',
            upd_progress_install: 'Installing',
            upd_done_title: '✅ Update installed',
            upd_done_text: 'Quit and relaunch Illustrator to use the new version.',
            upd_error_prefix: 'The update could not be applied: ',
            upd_error_fallback: 'You can download the installer instead.',
            upd_restart_banner: '🔄 Update installed: relaunch Illustrator to activate it.',
            upd_skip: 'Later',
        ...
        es: {
            ...
            col_monochrome_light: 'Monocromo claro (fondo negro para JPG)',
            ...
            lic_manage_subscription: 'Gestionar o cancelar mi suscripción (portal Lemon Squeezy)',
            ...
            upd_hot_notice: '💡 La actualización se instala directamente en el plugin. Recuerda reiniciar Illustrator cuando termine.',
            upd_installer_notice: '📦 Esta versión se instala con el instalador. La descarga empieza en tu navegador: cierra Illustrator, ejecuta el instalador y vuelve a abrir Illustrator. Todas las versiones: logotyps.fr/download',
            upd_apply: 'Descargar e instalar',
            upd_installer_download: 'Descargar el instalador',
            upd_close: 'Cerrar',
            upd_progress_start: 'Preparando…',
            upd_progress_download: 'Descargando',
            upd_progress_install: 'Instalando',
            upd_done_title: '✅ Actualización instalada',
            upd_done_text: 'Cierra y vuelve a abrir Illustrator para usar la nueva versión.',
            upd_error_prefix: 'No se pudo aplicar la actualización: ',
            upd_error_fallback: 'Puedes descargar el instalador en su lugar.',
            upd_restart_banner: '🔄 Actualización instalada: reinicia Illustrator para activarla.',
            upd_skip: 'Más tarde',
        ...
        it: {
            ...
            col_monochrome_light: 'Monocromatico chiaro (sfondo nero per JPG)',
            ...
            lic_manage_subscription: 'Gestire o annullare il mio abbonamento (portale Lemon Squeezy)',
            ...
            upd_hot_notice: '💡 L\'aggiornamento si installa direttamente nel plugin. Ricorda di riavviare Illustrator al termine.',
            upd_installer_notice: '📦 Questa versione si installa con l\'installer. Il download parte nel browser: chiudi Illustrator, esegui l\'installer, poi riapri Illustrator. Tutte le versioni: logotyps.fr/download',
            upd_apply: 'Scarica e installa',
            upd_installer_download: 'Scarica l\'installer',
            upd_close: 'Chiudi',
            upd_progress_start: 'Preparazione…',
            upd_progress_download: 'Download',
            upd_progress_install: 'Installazione',
            upd_done_title: '✅ Aggiornamento installato',
            upd_done_text: 'Chiudi e riavvia Illustrator per usare la nuova versione.',
            upd_error_prefix: 'Impossibile applicare l\'aggiornamento: ',
            upd_error_fallback: 'Puoi scaricare l\'installer al suo posto.',
            upd_restart_banner: '🔄 Aggiornamento installato: riavvia Illustrator per attivarlo.',
            upd_skip: 'Più tardi',
